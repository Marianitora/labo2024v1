...
PARAM$hs <- makeParamSet(
    ...
    makeIntegerParam("minsplit", lower = 250L, upper = 600L),
    makeIntegerParam("minbucket", lower = 125L, upper = 300L),
...
setwd("C:\\Users\\Mariano\\OneDrive\\Documentos\\Miscelaneas\\Austral\\2do cuatrimestre\\Lab de implementación")
